...
function updateChartConfig(chartConfig){
  ...
  config.sluggyModelName = _.slugify(_.humanize(chartConfig.modelName)); //un-ele-a-e
...
function createChart(_this, appDir, templatesDir){
  ...
  _this.template('chart/highchart.html', appDir+'/client/src/app/'+_this.camelModuleName+'/'+_this.camelModelName+'.html');//chart page
  _this.template('chart/highchart.js', appDir+'/client/src/app/'+_this.camelModuleName+'/'+_this.camelModelName+'.js');//chart page controller


  _this.template(templatesDir+'/chart/ds.js', appDir+'/client/src/app/ds/'+_this.camelModelName+'.js');//ds
